...
#
#Job.create(title: "Clean the messy kitchen up.", image_url: "https://c8.alamy.com/comp/P4JF7J/dirty-dark-kitchen-in-an-old-beggars-house-a-grim-abstract-scene-about-poverty-and-housing-problems-P4JF7J.jpg", description: "The old messy kitchen is there for you to clean still", user_id: raul.id)